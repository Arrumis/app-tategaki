...
### **手順 2-3: モックデータ（ダミーデータ）の投入**
フロントエンド開発やアプリ連携処理テストのために、仮のデータを作る。

- **作業:** `data/favs/default.json` や `data/novels/narou/12345/info.json` を手動作成する。

### **手順 2-4: アプリ連携処理エンドポイントの実装**
